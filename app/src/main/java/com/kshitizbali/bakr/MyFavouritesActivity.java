...
public class MyFavouritesActivity extends AppCompatActivity implements MasterRecipeListFragment.OnRecipeClickListener, RecipeDetailFragment.OnRecipeStepClickListener, RecipeStepDetailFragment.onFabRecipeStepChangeListener, MasterRecipeListFragment.onFavSelectedClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instantiateViews();
        if (NetworkUtilities.isInternetAvailable(MyFavouritesActivity.this)) {
            onStartFragmentLoad();
        } else {
    ...
    private void onStartFragmentLoad() {
        ...
        if ((getSupportFragmentManager().getBackStackEntryCount() == 0)) {
            ...
            Bundle args = new Bundle();
            args.putBoolean(ConstantUtilities.SHOW_WIDGET_DATA, true);
            newFragment.setArguments(args);
    ...
    public void onRecipeFavOrNot(final int recipeId, String recipeFavOrNot) {
        ...
        AppExecutors.getInstance().diskIO().execute(new Runnable() {
            ...
            public void run() {
                ...
                BakrFavouriteService.startActionShowFav(MyFavouritesActivity.this);
            }
        });
    }
  ...
  /*  @Override
    ...
    private void onBackPressFragmentsMethod() {
        ...
        if (tag != null && tag.equals(ConstantUtilities.RECIPE_STEP_DETAIL)) {
            ...
            finish();
            Intent i = new Intent(MyFavouritesActivity.this, MainActivity.class);
            startActivity(i);
